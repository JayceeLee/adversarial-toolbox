...
save_adv = '/home/neale/repos/adversarial-toolbox/images/adv-resnet50-nolabel/'
save_adv_label = '/home/neale/repos/adversarial-toolbox/images/adv-resnet50-label/'
...
for idx, path in enumerate(paths):
    ...
    imsave(save_adv+"adv_resnet50_{}.png".format(idx, image), image)
    #plt.figure()
    plt.imshow(image)
    plt.title(str_label_orig + ' --> ' + str_label_pert)
    plt.savefig(save_adv_label+'adv_resnet50_label_{}'.format(idx))
    #plt.show()
