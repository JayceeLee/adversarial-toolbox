...
from cleverhans.attacks import ElasticNetMethod as ENM
import numpy as np
...
tf.flags.DEFINE_string(
        'checkpoint_path', './weights/inception_resnet_v2/inception_resnet_v2.ckpt', 'Path to checkpoint for inception network.')
