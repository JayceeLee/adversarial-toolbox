...
from tf_models import InceptionV3Model
...
tf.flags.DEFINE_string(
        'checkpoint_path', 
        '/home/neale/repos/adversarial-toolbox/toolbox/attacks/MIM-Attack/test_new_class/nets/checkpoints/inception_v3.ckpt', 
