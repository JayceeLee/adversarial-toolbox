...
def main(args):
    with tf.Session() as sess:
        ...
        for i in range(all_true_ids.size):
            ...
            suffix = "prev{}_adv{}".format(original_class[-1], adversarial_class[-1])
            show(inputs, "{}/{}_im_{}.png".format(args['save_real'], img_no, suffix))
            # show(inputs, "{}/{}/{}_original_{}.png".format(args['save_real'], args['dataset'], img_no, suffix))
            show(adv, "{}/{}_adv_{}.png".format(args['save_adv'], img_no, suffix))
            # show(adv, "{}/{}/{}_adversarial_{}.png".format(args['save_adv'], args['dataset'], img_no, suffix))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_real", default="/home/neale/repos/adversarial-toolbox/images/adversarials/cw/imagenet/symmetric/l2/inception_v3/real")
    parser.add_argument("--save_adv", default="/home/neale/repos/adversarial-toolbox/images/adversarials/cw/imagenet/symmetric/l2/inception_v3/adv")
