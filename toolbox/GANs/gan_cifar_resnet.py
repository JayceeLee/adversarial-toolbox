...
DATA_DIR = '/home/neale/repos/adversarial-toolbox/toolkit/cifar-10-batches-py'
...
with tf.Session() as session:
    ...
    def generate_image(frame, true_dist):
        ...
        lib.save_images.save_images(samples.reshape((100, 3, 32, 32)), 'samples_{}.png'.format(frame), 'ac-gan_adv')
