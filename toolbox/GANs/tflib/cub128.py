...
def load_cub128(batch_size, data_dir='/home/neale/repos/adversarial-toolbox/images/cub128'):
    return (
        make_generator(data_dir+'/train', 4999, batch_size),
        make_generator(data_dir+'/valid', 1032, batch_size)
    )

if __name__ == '__main__':
    train_gen, valid_gen = load_cub128(64)
    t0 = time.time()
